...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $error_message = "Username atau password salah, atau Anda bukan admin.";
    }
...
<head>
    ...
    <title>Admin Login - Azra Beauty Clinic</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-blue-100 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-lg p-6 md:p-8 w-full max-w-md">
        <h1 class="text-2xl md:text-3xl font-bold text-blue-500 text-center mb-6">Admin Login</h1>
